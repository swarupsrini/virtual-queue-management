...
export default function StoreCard(props) {
  ...
  return (
    <Card className={classes.root}>
      ...
      <CardActions>
        <Button onClick={props.joinClick} color="primary" size="small"><strong>Join Queue</strong></Button>
        <Button onClick={props.viewClick} color="primary" size="small"><strong>View Data</strong></Button>
        <IconButton onClick={favoriteClick} aria-label="favorite">
          {favorited ? <StarIcon></StarIcon> : <StarBorderIcon></StarBorderIcon>}
        </IconButton>
      </CardActions>
    </Card>
  );
